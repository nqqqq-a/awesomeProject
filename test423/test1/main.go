...
3)如果某个用户名存在，就将其密码修改"888888"，如果不存在就增加这个用户i信息，(包括昵称nickname 和密码pwd) 。
4)编写一个函数modifyUser(uses map[string]map[string]string，name string)完
成上述功能
*/
